...
class ACT(Export, Policy):
    ...
    def setup(self, stage: str) -> None:
        ...
        # Save to hparams so ModelCheckpoint persists dataset_stats in the checkpoint.
        # Without this, load_from_checkpoint reconstructs ACT with dataset_stats=None
        # and the model is never initialized, breaking inference.
