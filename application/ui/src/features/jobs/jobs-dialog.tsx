...
import { ChevronDownSmallLight, ChevronUpSmallLight, Delete } from '@geti-ui/ui/icons';
    ...
    return (
        <Dialog
            UNSAFE_style={{
                ...
                '--spectrum-dialog-padding-y': 'var(--spectrum-global-dimension-size-200)',
                '--spectrum-dialog-padding-x': 'var(--spectrum-global-dimension-size-200)',
            }}
            maxWidth={'min(985px, 95vw)'}
            minWidth='min(985px, 95vw)'
            maxHeight={'min(985px, 95vh)'}
            minHeight='min(985px, 95vh)'
        >
            <Content>
                {1 + 1 > 3 && (
                ...
                >
                    <TabList UNSAFE_className={classes.tab}>
                        ...
                        <Item key='scheduled'>
                            <StatusTab counts={counts['pending'] ?? 0}>Scheduled jobs</StatusTab>
                        </Item>
                        <Item key='canceled'>
                    ...
                    <TabPanels marginTop='size-100' UNSAFE_style={{ overflowY: 'scroll' }}>
                        <Item key='all'>
                            <JobsList jobs={jobs} />
                        </Item>
                        <Item key='running'>
