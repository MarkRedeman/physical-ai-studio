...
type TrainerSettingsFormProps = {
    trainer: SchemaTrainerClientSettings;
};
    ...
    return (
        ...
        >
            ...
            <NumberField
                ...
                onChange={(value) => {
                    if (!Number.isNaN(value)) {
                        setStreamReconnectBackoffMaxS(value);
                        markDirty();
                    }
                }}
                width='100%'
