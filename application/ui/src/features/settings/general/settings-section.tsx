...
/**
 * A self-contained settings group: header, form fields, and a Save button that
 * PATCHes only this section (secrets the user didn't touch are left unchanged).
 */
export const SettingsSection = ({
    ...
    return (
        <View UNSAFE_className={classes.section} padding='size-300'>
            ...
            {description !== undefined && <Text UNSAFE_className={classes.description}>{description}</Text>}
