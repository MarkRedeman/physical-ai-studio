...
Pi0.5 is a vision-language-action policy designed for open-world robot control from multimodal observations and
language instructions. It can consume images, robot state, and task text and produce action chunks for robot execution.
