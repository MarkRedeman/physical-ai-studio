...
class TrainingWorker(BaseProcessWorker):
    ...
    def _create_datamodule(
        snapshot_path: Path, train_batch_size, *, source_dataset_path: Path | None = None
    ) -> DataModule:
        ...
        if manifest_file.exists():
            ...
            return DataModule(train_dataset=dataset, train_batch_size=train_batch_size)
        ...
        *,
        ...
        try:
            ...
            datamodule = self._create_datamodule(
                snapshot_path, train_batch_size=payload.batch_size, source_dataset_path=source_dataset_path
            )
