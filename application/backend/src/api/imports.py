...
from api.dependencies import get_dataset_import_service, get_job_service, get_model_import_service, get_project_id
...
async def prepare_dataset_import_job(
    ...
    return await dataset_import_service.prepare_dataset_import_job(
        project_id=project_id, source_hint=source_hint, dataset_name=dataset_name.strip()
    )
