"""Example catalog plugin for Physical AI Studio.

This file demonstrates how an external package would implement a robot
catalog plugin. It is NOT registered in the built-in registry; external
packages register via the ``physicalai.studio.catalog_plugins`` entry
point using ``register_physicalai_studio_plugin``.
"""
