...
from schemas.import_job import DatasetManifestRecordingSchema, ManifestCameraEntry, ManifestRobotEntry
...
def _extract(info: dict) -> DatasetManifestRecordingSchema:
    features: dict = {}
